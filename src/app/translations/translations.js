...
export const translations = {
  ...
  ar: {
    ...
    home: {
      ...
      globalPresenceTextone: "تُعد مجموعة شركات باور تك (Power Tech Group of Companies)، وهي منظمة حاصلة على شهادات ISO 9001 وISO 14001 وISO 45001، مزودًا فريدًا للحلول المتكاملة والشاملة لخدمات محطات الطاقة في شبه القارة الهندية ودول مجلس التعاون الخليجي. نقدم خدمات الإصلاحات والتحديثات، وعقود الهندسة والمشتريات والإنشاءات (EPC)، وخدمات التشغيل والصيانة (O&M)، وإعادة الهندسة، ونقل محطات الطاقة، وقطع الغيار والخدمات الفنية.",
      globalPresenceTexttwo: "نقدم بدائل عالية الجودة وفعّالة من حيث التكلفة لخدمات الشركات المصنعة للمعدات الأصلية (OEM)، مدعومة بخبرة تقنية قوية وخبرة واسعة في المجال الصناعي. تركز حلولنا على تحسين موثوقية محطات الطاقة وكفاءتها وسلامتها وأدائها التشغيلي.",
