...
export async function POST(req) {
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: process.env.EMAIL_USER||'enquiry.samtechsa26@gmail.com',
        pass: process.env.EMAIL_PASS || 'dusghgjwdzdxvmgm',
      },
    });

    const mailOptions = {
      from: `"Sam Tech Contact Form" <${process.env.EMAIL_USER||'enquiry.samtechsa26@gmail.com'}>`,
      to: process.env.EMAIL_TO||'enquiry.samtechsa26@gmail.com',
